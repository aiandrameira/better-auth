export function getVerificationEmailHtml(url: string, userName: string = "Usuário") {
    return `
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
                        ...
                        <tr>
                            <td style="padding: 20px 40px 30px 40px; text-align: center;">
                                ...
                                <p style="margin: 0 0 30px 0; color: #6a6a6a; font-size: 16px; line-height: 24px;font-weight: 500;">
                                    Obrigado por se cadastrar! Para ativar a sua conta, por favor, clique no botão abaixo para verificar seu e-mail.
                                </p>
